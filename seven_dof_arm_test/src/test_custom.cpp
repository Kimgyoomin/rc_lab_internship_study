...
int main(int argc, char **argv)
{
    ...
    ROS_INFO("Reference Time : %s", group.getEndEffectorLink().c_str());
    ...
    ROS_INFO("Visualization paln 1 (pose goal) %s", success ? "SUCCEEDED":"FAILED");
    // ROS_INFO("Visualization plan 1 (pose goal) %s", success ? "SUCCEEDED" : "FAILED");
